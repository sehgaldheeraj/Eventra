...
{
    public class IssueClosedNoticeHandler(INoticeRepository noticeRepository) : INotificationHandler<DomainEventNotification<IssueClosed>>
    {
        private readonly INoticeRepository _noticeRepository = noticeRepository;

        public async Task Handle(DomainEventNotification<IssueClosed> notification, CancellationToken ct)
        {
